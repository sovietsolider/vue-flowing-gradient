...
const config = computed<GradientConfig>(() => {
  ...
  if (props.config) {
    if (props.config.color1)
      normalized.color1 = normalizeColor(props.config.color1);
    if (props.config.color2)
      normalized.color2 = normalizeColor(props.config.color2);
    if (props.config.color3)
      normalized.color3 = normalizeColor(props.config.color3);
