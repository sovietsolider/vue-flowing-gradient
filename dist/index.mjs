import { defineComponent, createElementBlock, openBlock, normalizeClass, computed, ref, onMounted, nextTick, onUnmounted, watch } from 'vue';
import { Renderer, Plane, Program, Mesh, Transform } from 'ogl';
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock(
    ...
    {
      ref: "canvasRef",
      class: normalizeClass($setup.cn("w-full h-full block select-none touch-none", $props.className)),
      style: {
        width: "100%",
        height: "100%",
        display: "block"
...
export { DEFAULT_CONFIG, GRADIENT_TYPE_NUMBER, GradFlow_default as GradFlow, PRESETS, generateRandomColors, hexToRgb, normalizeColor, randomRGB, rgbToHex };
